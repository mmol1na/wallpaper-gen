  ...
  "focus-visible:border-ring focus-visible:ring-ring/30 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive dark:aria-invalid:border-destructive/50 rounded-md border border-transparent bg-clip-padding text-xs/relaxed font-medium focus-visible:ring-[2px] aria-invalid:ring-[2px] [&_svg:not([class*='size-'])]:size-4 inline-flex items-center justify-center whitespace-nowrap transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none shrink-0 [&_svg]:shrink-0 outline-none group/button select-none",
  {
    variants: {
      variant: {
        ...
        hud: "border-border text-muted-foreground hover:border-primary/50 hover:text-foreground active:scale-[0.98] duration-150",
        "hud-primary":
          "border-primary bg-primary/20 text-primary hover:bg-primary/30 active:scale-[0.98] duration-150",
        "hud-dashed":
          "border-dashed border-border text-muted-foreground hover:border-primary/50 hover:text-foreground duration-150",
        "hud-ghost": "border-transparent text-muted-foreground hover:text-foreground duration-150",
      },
      size: {
        default:
        ...
        hud: "px-2 py-1.5 text-[10px] uppercase tracking-wider",
        "hud-sm": "px-1 py-1 text-[9px] uppercase tracking-wider",
      },
    },
    defaultVariants: {
      variant: "default",
